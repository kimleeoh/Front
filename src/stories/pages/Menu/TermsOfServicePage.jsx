    ...
    return (
        <PageContainer>
            ...
            <Content maxWidth={windowSize}>
                ...
                <p>
                    본 약관은 [에프킬러] (이하 "A-F Killer")의 이용과 관련하여
                ...
                <p>
                    ...
                    생성된 서비스 로그인 정보를 말합니다.
                </p>
                <p>
                    <strong>제 3조 (회원가입 및 정보수집)</strong>
                </p>
                <p>
                    이용자는 앱 자체 아이디를 통한 계정을 생성하여 서비스에
                    가입할 수 있습니다. 회사는 서비스 제공을 위해 이용자로부터
                    다음의 정보를 수집합니다: 닉네임, 학번, 프로필 사진, 성적.
                    수집된 정보는 서비스 운영 및 개선, 맞춤형 서비스 제공, 통계
                    분석 등의 목적으로 사용됩니다.
                </p>
                <p>
                ...
                <p>
                    회사는 이용자에게 다음과 같은 서비스를 제공합니다: 공부 관련
                    문답 서비스 공부 관련 게시판 서비스 맞춤형 활동 보고 서비스
