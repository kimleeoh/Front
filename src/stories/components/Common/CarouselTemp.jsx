...
const CarouselTemp = ({
    ...
    useEffect(() => {
      ...
      const currentSlideElement = containerRef.current?.children[currentSlide];
      if (currentSlideElement) {
          const backgroundColor = window.getComputedStyle(currentSlideElement).backgroundColor;
...
const LeftButton = styled(NavigationButton)`
  ...
  svg path {
    stroke: ${props => props.color};  // Fraction Color에 따른 stroke 색상 설정
  }
`;
